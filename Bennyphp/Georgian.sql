...
INSERT INTO `Georgian` (`stnumber`, `stname`, `stprogram`, `stterm`, `stage`) VALUES
...
--
-- Indexes for table `Georgian`
--
ALTER TABLE `Georgian`
...
--
-- AUTO_INCREMENT for table `Georgian`
--
ALTER TABLE `Georgian`

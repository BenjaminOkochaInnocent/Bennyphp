...
<?php
  ...
  class Database{
    ...
    public function create($stnumber, $stname, $stprogram, $stterm, $stage){
      $sql = "INSERT INTO Georgian (stnumber, stname, stprogram, stterm, stage) VALUES ('$stnumber', '$stname', '$stprogram', '$stterm', '$stage')";
...
<body>
  <header>
    ...
    <nav class="navbar navbar-dark bg-primary">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><img src="./img/unilogo.png" alt="Header Logo"></a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">Student Input</a></li>
  ...
  <section class="masthead">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="text-center">Georgian <br> College</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p class="text-center">&copy; <?php echo date("Y"); ?>Georgian College. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </footer>
